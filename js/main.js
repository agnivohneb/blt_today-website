...
$(".bg-cover").imagesLoaded({
	...
	var o = $(".st-countdown");
	o.countdown("2017/09/01", function(e) { // Countdown Date
	...
	isFirefox ? c = "0px" : mobileVar && (c = "2px"), o.countdown("pause"), r.length && (t = new SplitText(r, {
		...
		opacity: 1,
		ease: Bounce.easeOut
	}, .01), l.addLabel("end"), l.call(e, [])), s.length && (a = new SplitText(s, { // Time1 .01
		type: "words,chars",
